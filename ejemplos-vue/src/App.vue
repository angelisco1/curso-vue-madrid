<template>
  <div>
    <h1 v-marcar="{bgColor: 'red', color: 'yellow'}">Curso de Vue</h1>
    <!-- <componente-local /> -->
    <!-- <cmp-local></cmp-local> -->
...
//   'div',
//   null,
//   h('h1', null, 'Curso de Vue'),
//   h('h2', null, 'Esto es un componente local')
//   h('h2', null, 'Esto es un componente global')
// )
</script>
